...
#define MODBUS_MAPPING_SIZE 20 // in words (16-bits)
...
uint16_t ModbusSlaveRegisters[MODBUS_MAPPING_SIZE];
...
void loop()
{
    ...
    ControllinoModbusSlave.poll(ModbusSlaveRegisters, MODBUS_MAPPING_SIZE);
    ...
    ModbusSlaveRegisters[19] = 0xDEAD;
}
